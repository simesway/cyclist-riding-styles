...
Radar plots of cluster centers (Figure \ref{fig:o-regime-centers}) and correlation matrices (Appendix Table Y) summarize the feature-level distinctions.
...
Clustering reveals five distinct overtaking execution styles that differ primarily in speed, acceleration strategy, lateral passing behavior, and temporal stability of behavioral regimes.
